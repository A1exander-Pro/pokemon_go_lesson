...
- Для добавления покемонов и их свойств необходимо зарегистрировать супер-пользователя, с помощью которого  
через админ панель можно будет добавлять/редактировать покемонов   
