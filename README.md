...
- Для добавления покемонов и их свойств необходимо зарегистрировать супер-пользователя, с помощью которого через админ панель можно будет добавлять/редактировать покемонов   

```sh
python3 manage.py createsuperuser
```   
Далее по инструкции придумайте логин и пароль, с помощью которых вы войдете в админ панель.   
...
- После того как сервер был запущен, допишите к URL сервера `/admin`, например:   

```
http://127.0.0.1:8000/admin/
```   

- Далее вводите логин и пароль от superuser`а, который вы создали и заходите в админ панель.
## Цели проекта
